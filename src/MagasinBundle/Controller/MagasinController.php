...
class MagasinController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $magasins = $em->getRepository('MagasinBundle:Magasin')->findAll();
    ...
    {
        $magasin = new Magasin();
        $form = $this->createForm('MagasinBundle\Form\MagasinType', $magasin);
    ...
    {
        $deleteForm = $this->createDeleteForm($magasin);
        $editForm = $this->createForm('MagasinBundle\Form\MagasinType', $magasin);
